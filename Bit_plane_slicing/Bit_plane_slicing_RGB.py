...
class BitPlaneSlicingApp:
    ...
    def __init__(self, root):
        ...
        self.root.title(
            "Color Bit-Plane Slicing | Digital Image Processing"
        )
    ...
    def create_main_area(self):
        ...
        tk.Label(
            header,
            text="Decompose a full-color RGB image into individual color bit planes",
            font=("Segoe UI", 10),
            fg=self.gray,
            bg=self.bg
        ).pack(
    ...
    def get_bit_plane(
        ...
        # Convert image to RGB and extract R, G and B channels
        ...
        bit_plane = (
            (image_array >> plane_number) & 1
        ) * 255

        # Keep the three channels, so the bit plane remains colorful
    ...
    def show_all_planes(self):
        ...
        tk.Label(
            header,
            text="Bit 7 = MSB     •     Bit 0 = LSB     •     RGB Color Planes",
            font=("Segoe UI", 10),
            fg=self.gray,
            bg="#111827"
        ).pack(
